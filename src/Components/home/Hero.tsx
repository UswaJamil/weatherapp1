      ...
      >
        ...
        >
          ...
          <div className="w-full max-w-sm md:max-w-2xl text-center">
            <h1 className="text-[clamp(22px,6vw,32px)] font-bold text-center leading-tight -tracking-[0.3px]" style={{ color: COLORS.textPrimary }}>
              {page.data.heading}
            </h1>

            <p className="text-[clamp(13px,3.5vw,16px)] opacity-[0.88] mt-2 mb-5 text-center leading-[1.35] -tracking-[0.2px]" style={{ color: COLORS.textSecondary }}>
              {page.data.subtitle}
            </p>
