...
const backgrounds = {
  ...
  "Cloudy-Day": require("../assets/images/Cloudy-Day.png"),
  "Cloudy-Night": require("../assets/images/Cloudy-Night.png"),
  "FewClouds-Day": require("../assets/images/Fewclouds-Day.png"),
  "FewClouds-Night": require("../assets/images/Fewclouds-Night.png"),
  "Rain-Day": require("../assets/images/Rain-Day.png"),
  "Rain-Night": require("../assets/images/Rain-Night.png"),
  "Snow-Day": require("../assets/images/Snow-Day.png"),
  "Snow-Night": require("../assets/images/Snow-Night.png"),
  "Storm-Day": require("../assets/images/Storm-Day.png"),
  "Storm-Night": require("../assets/images/Storm-Night.png"),
};
